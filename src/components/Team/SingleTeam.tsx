        ...
        <div className="text-center">
          ...
          />
            ...
            >
              ...
              >
                <path
                  d="M15.995 0H2.005C0.896 0 0 0.895 0 2.002V15.998C0 17.106 0.896 18 2.005 18H15.995C17.104 18 18 17.106 18 15.998V2.002C18 0.895 17.104 0 15.995 0ZM5.476 13.276H3.464V6.711H5.476V13.276ZM4.470 5.742C3.657 5.742 3.023 5.104 3.023 4.296C3.023 3.489 3.657 2.858 4.470 2.858C5.283 2.858 5.916 3.489 5.916 4.296C5.916 5.104 5.283 5.742 4.470 5.742ZM14.535 13.276H12.524V9.683C12.524 8.573 12.522 7.287 11.327 7.287C10.168 7.287 9.788 8.074 9.788 9.141V13.276H7.777V6.711H9.788V7.845C9.931 6.930 10.529 6.423 11.302 6.423C13.090 6.423 14.535 7.959 14.535 9.679V13.276Z"
                  fill=""
                />
              </svg>
