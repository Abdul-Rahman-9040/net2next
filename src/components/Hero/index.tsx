...
const Hero = () => {
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                Transforming businesses with innovative IT services, web & app development, consultancy, and training, bridging the gap from traditional to next-gen solutions.
                </p>
  ...
  >
    ...
    >
      <path d="M21 16.5c-1.4 0-2.5 1.1-2.5 2.5 0 2.1-1.7 3.8-3.8 3.8-1.3 0-2.6-.5-3.6-1.4l-1.2 1.2c-.6.6-1.6.6-2.2 0l-2.7-2.7c-.6-.6-.6-1.6 0-2.2l1.2-1.2c-.9-1-1.4-2.3-1.4-3.6 0-2.1 1.7-3.8 3.8-3.8 1.4 0 2.5 1.1 2.5 2.5s1.1 2.5 2.5 2.5c.6 0 1.2-.1 1.8-.3 1.3-.5 2.2-1.8 2.2-3.2 0-2.1-1.7-3.8-3.8-3.8-1.3 0-2.6.5-3.6 1.4l-1.2-1.2c-.6-.6-1.6-.6-2.2 0l-2.7 2.7c-.6.6-.6 1.6 0 2.2l1.2 1.2c-.9 1-1.4 2.3-1.4 3.6 0 2.1 1.7 3.8 3.8 3.8 1.4 0 2.5-1.1 2.5-2.5s1.1-2.5 2.5-2.5c1.1 0 2.1-.4 2.9-1.1 1.2-.9 1.9-2.3 1.9-3.7z" />
    </svg>
    Contact Us
  </Link>
</li>
                ...
                <div>
                  ...
                  Net2Next is now available across all leading frameworks, offering seamless integration and enhanced performance.
                  </p>
                  <div
            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mt-16">
                  <Image
                    src="/images/hero/hero-image.gif"
                    alt="hero"
